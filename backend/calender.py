...
class IcalUrlModel(BaseModel, db.Model):
    ...
    ical_id: int | Column = Column(Integer, primary_key=True, name="ical_id")
...
class CalenderModel(BaseModel, db.Model):
    ...
    calender_id: int | Column = Column(Integer, primary_key=True, name="calender_id")
    calender_name: str | Column = Column(String(16), nullable=False)

    def __init__(self, calender_id: int | None = None, calender_name: str | None = None):
        self.calender_id = calender_id
...
class CalenderManager:
    ...
    def create(calender_name: str, ical_urls: list[str]):
        calender = CalenderModel(None, calender_name)
